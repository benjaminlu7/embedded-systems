...
/*
================================================================================================
Embedded Systems - custom-header.php
================================================================================================
...
================================================================================================
*/
function embedded_systems_custom_header_setup() {
    $args = array(
        ...
        'wp-head-callback'       => 'embedded_systems_header_style',
    );
    ...
    'header-image' => array(
        ...
        'description'   => __( 'Header Image', 'embedded-systems')
    )));
}
add_action('after_setup_theme', 'embedded_systems_custom_header_setup');
...
================================================================================================
*/
function embedded_systems_header_style() {
