        ...
        <div id="content-area" class="content-area">
            ...
            <?php 
                the_post_navigation(array(
                    'next_text' => '<span class="post-next" aria-hiddent="true">' . __('Next', 'embedded-systems') . '</span>' . '<span class="post-title">%title</span>',
                    'prev_text' => '<span class="post-previous" aria-hidden="true">' . __( 'Previous', 'embedded-systems') . '</span> ' . '<span class="post-title">%title</span>',
                )); 
            ?>
